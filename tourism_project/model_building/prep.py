...
DATASET_PATH = "hf://datasets/bhupal522/Tourism-Customer-Prediction/tourism.csv"
tourism_dataset = pd.read_csv(DATASET_PATH)
print("Dataset loaded successfully.")

# Drop unnamed and unique identifier columns
...
for column in categorical_columns:
    tourism_dataset[column] = label_encoder.fit_transform(tourism_dataset[column])
