...
with mlflow.start_run():
    ...
    model_path = "best_tourism_customer_prediction_v1.joblib"
    ...
    repo_id = "bhupal522/Tourism-Customer-Prediction"
    repo_type = "model"
    ...
    # upload the best model library to model repository
    api.upload_file(
        path_or_fileobj="best_tourism_customer_prediction_v1.joblib",
        path_in_repo="best_tourism_customer_prediction_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
